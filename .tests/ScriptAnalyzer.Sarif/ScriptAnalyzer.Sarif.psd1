#
# Module manifest for module 'ScriptAnalyzer.Sarif'
#

@{

  # Script module or binary module file associated with this manifest.
  RootModule           = 'ScriptAnalyzer.Sarif.psm1'
  ...
  GUID                 = 'e133fe6c-d298-4da4-afe6-73f39cad9318'
  ...
  Description          = 'Convert ScriptAnalyzer results to SARIF for GitHub code analysis'
