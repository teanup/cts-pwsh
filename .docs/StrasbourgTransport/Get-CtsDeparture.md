...
```
Get-CtsDeparture [[-Stop] <string[]>] [[-Destination] <string[]>] [-Line <string[]>] [-Strict]
 [-MaxDepartures <int>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Object

```
Get-CtsDeparture -StopObject <Stop[]> [-MaxDepartures <int>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
